...
export default function OnboardingRun() {
    ...
    return (
        <OnboardingContainer title={node === 'hardhat' ? 'Run Hardhat' : 'Run Anvil'}>
            <Stack gap="20px">
                ...
                <Text color="text/secondary" size="14px">
                    When DevWallet detects your{' '}
                    {node === 'hardhat' ? 'Hardhat node' : 'Anvil instance'} is running, we
                    will redirect you.
                </Text>
            </Stack>
        </OnboardingContainer>
